<nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
    ...
    <a href="{{route('pages.index')}}" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
        <img src="{{asset('/assets/img/logo/logo.webp')}}"  alt="Ecomgladiators Logo"  height="50px" />
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="{{route('pages.about')}}" class="nav-item nav-link {{request()->routeIs('pages.about') ? 'active' : ''}}">About Us</a>
