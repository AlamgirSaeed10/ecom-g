                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 p-4">
                        ...
                        <p><strong>Global E-commerce Business</strong><br>Welcome to Ecomgladiators, your premier e-commerce service provider specializing in Amazon
                            ...
                            France,
                            we offer tailored solutions to help businesses thrive in these lucrative regions.</p>
                        <p>From product sourcing and brand development to optimized listing creation and inventory
                            management,
                            we handle every aspect of your e-commerce journey. With our comprehensive knowledge of
                            international
                            regulations and logistics,
                            we ensure smooth operations, timely delivery, and customer satisfaction across borders.</p>
                        <p>Trust Ecomgladiators to be your trusted partner in expanding your e-commerce presence
                            globally,
                            connecting you with millions
                            of potential customers and driving your business toward unprecedented growth.</p>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-contact contact_form" id="enrollment_form" action="" method="POST">
                        @csrf
